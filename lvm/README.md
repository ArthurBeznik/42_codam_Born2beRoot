...
As the screenshots show, I'm configuring this partition to be an **ext4 filesystem, mounted at `/home`, and labeled as home**.

***MARES WARNING:*** You have do the same thing for `root`, configuring for root, not boot. For `swap` instead of being an ext4 filesystem, select **swap area**.
